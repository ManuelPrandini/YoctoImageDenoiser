...
![coffee path tracing](./tests/images/ldr/16_coffee/16_coffee_1280_128.jpg =50x20)
The output produced by the two denoiser are the follow:
### Output of Intel ldr
![coffee Intel](./out/ldr/intel/16_coffee_1280_128.jpg)
With much noise is possible to obtain great results also in scenes with much light like this one.
### Output of NLM ldr
![coffee NLM](./out/ldr/nlm/16_coffee_1280_128.jpg)
